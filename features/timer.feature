...
Scenario: Select Aeropress and press start
...
Scenario: Select Chemex and press start
...
Scenario: Select Clever and press start
...
Scenario: Select Espresso and press start
...
Scenario: Select French Press and press start
...
Scenario: Select Pour Over and press start
