...
public class AddEditLog extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (Build.VERSION.SDK_INT >= 11) {
			...
			rating_picker.setMinValue(5);
			rating_picker.setMaxValue(1);
			...
			temp_picker.setMinValue(225);
			temp_picker.setMaxValue(150);
			...
			grind_picker.setMinValue(40);
			grind_picker.setMaxValue(1);
			...
			if (deviceName.equals("espresso")) {
				...
				tamp_picker.setMinValue(40);
				tamp_picker.setMaxValue(20);
